...
public interface IAliPayService {
	 ...
	 * @param product
	 * @return String
	 * @Date 2017年7月27日 更新日志 2017年7月27日 拓胜科技 首次创建 备注：人民币单位为分 attach 附件参数 使用json格式传递
	 *       用于回调区分
	 */
	 ...
	 * @param product
	 * @return String
	 * @Date 2017年7月30日 更新日志 2017年7月30日 拓胜科技 首次创建
	 *
	 */
	 ...
	 * @param product
	 * @return String
	 * @Date 2017年9月21日 更新日志 2017年9月21日 拓胜科技 首次创建
	 *
	 */
