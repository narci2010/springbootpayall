...
public class ClientCustomSSL {
	public static String doRefund(String url, String data) throws Exception {
		...
		File certfile = ResourceUtils
				.getFile("classpath:cert" + Constants.SF_FILE_SEPARATOR + ConfigUtil.CERT_PATH);
		...
		SSLContext sslcontext = SSLContexts.custom()
				.loadKeyMaterial(keyStore, ConfigUtil.MCH_ID.toCharArray()).build();
