 ...
 * 文件名：WeixinMobilePayController.java
 * 描述：  
 * 修改人： Narci.Lee  
 * 修改时间：2017年11月22日  
 * 跟踪单号：  
...
import com.toceansoft.common.utils.AddressUtils;
...
/**
 * 微信H5支付 创建者 拓胜科技 创建时间 2017年7月31日
 *
 */
@Api(tags = "微信H5支付")
@Controller
...
public class WeixinMobilePayController {
	...
	public String pay(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 在支付平台设置 JSAPI支付授权目录
		// http://www.gotofullstack.com/weixinMobile/
		// 在公众号设置回调域名
		// www.gotofullstack.com

		return "weixinpay/payPage2";
	}
	...
	public String dopay(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if ("SUCCESS".equals(returnCode)) {
			...
			if ("SUCCESS".equals(resultCode)) {
				...
				logger.info("package:" + packages + " orderNo:" + orderNo);
				url.append("redirect:/weixinMobile/payPage?");
				url.append("timeStamp=" + timestamp + "&nonceStr=" + nonceStr + "&package="
						+ packages);
